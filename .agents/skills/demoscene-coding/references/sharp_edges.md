# Demoscene Coding - Sharp Edges

## GPU Drivers Interpret Shaders Differently
...
CRITICAL
### **Description**
Same GLSL code produces different results (or crashes) on different GPUs
### **Symptoms**
...
CRITICAL
### **Description**
AudioContext won't start until user clicks something
### **Symptoms**
...
### **Detection Pattern**
audio|sound|music|oscillator|bytebeat
### **Solution**
...
## mediump Precision Causes Visual Artifacts

### **Id**
precision-qualifier-disasters
### **Severity**
HIGH
### **Description**
Lower precision saves bytes but creates banding and artifacts
### **Symptoms**
...
## Animation Speed Varies With Framerate
...
HIGH
### **Description**
Demo runs 2x fast on 120Hz or crawls on slow machines
### **Symptoms**
...
### **Detection Pattern**
animation|rotate|move|time|frame
### **Solution**
...
## Demo Fails on Competition Hardware

### **Id**
competition-machine-mismatch
### **Severity**
HIGH
### **Description**
Works on your setup, crashes or glitches at the party
### **Symptoms**
...
### **Id**
size-counting-errors
### **Severity**
HIGH
### **Description**
Demo is 4097 bytes for 4k compo, disqualified
### **Symptoms**
...
## Relying on Undefined Behavior That Varies
...
MEDIUM
### **Description**
Code works by accident on your machine, fails elsewhere
### **Symptoms**
...
### **Detection Pattern**
undefined|uninitialized|divide|bounds
### **Solution**
...
## Audio Clips and Distorts

### **Id**
synth-audio-clipping
### **Severity**
MEDIUM
### **Description**
Generated audio exceeds [-1, 1] range
### **Symptoms**
...
### **Detection Pattern**
audio|synth|oscillator|sound|music
### **Solution**
  Audio Safety:
