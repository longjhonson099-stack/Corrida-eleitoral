...
embedding-model-mismatch
### **Summary**
Query and document embedded with different models
### **Severity**
critical
### **Situation**
...
## Qdrant Hnsw Build Time

### **Id**
qdrant-hnsw-build-time
### **Summary**
HNSW build parameters dramatically affect index creation time
### **Severity**
high
### **Situation**
...
### **Detection Pattern**
m=.*(?:32|64)|ef_construct=.*(?:200|400)
### **Version Range**
>=1.0.0

## Pgvector Hnsw Disk Space

### **Id**
pgvector-hnsw-disk-space
### **Summary**
pgvector HNSW indexes can be larger than the data
### **Severity**
high
### **Situation**
...
quantization-recall-loss
### **Summary**
Scalar/binary quantization silently degrades recall
### **Severity**
high
### **Situation**
...
chunking-too-large
### **Summary**
Embedding entire documents loses specific information
### **Severity**
high
### **Situation**
...
### **Detection Pattern**
chunk_size.*(?:1000|2000)|embed.*full.*doc
### **Version Range**
>=1.0.0
...
no-reranking
### **Summary**
First-stage retrieval quality treated as final
### **Severity**
high
### **Situation**
...
embedding-api-costs
### **Summary**
Embedding API costs explode with naive implementation
### **Severity**
medium
### **Situation**
...
semantic-gap
### **Summary**
User queries use different words than documents
### **Severity**
medium
### **Situation**
...
cold-cache-thundering-herd
### **Summary**
All caches expire together, API gets hammered
### **Severity**
medium
### **Situation**
