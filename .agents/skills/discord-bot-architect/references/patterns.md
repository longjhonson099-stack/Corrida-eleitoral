...
15 minutes
    ##### **Ephemeral Note**
Can only be set on initial response, not changed later
...
Message Content for Commands
  #### **Description**
Don't parse message content for commands
  #### **Why Bad**
...
Syncing Commands on Every Start
  #### **Description**
Don't register commands on every bot startup
  #### **Why Bad**
...
Blocking the Event Loop
  #### **Description**
Don't run synchronous operations in event handlers
  #### **Why Bad**
