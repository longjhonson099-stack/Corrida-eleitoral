...
Never show invalid content to players
  #### **When**
Any procedural content that could be unplayable
  #### **Example**
...
Identical seeds produce identical results, always
  #### **When**
Any procedural system that needs debugging or sharing
  #### **Example**
...
Constraint-based generation from example patterns
  #### **When**
Generating content that matches specific aesthetic patterns, tilemap generation
  #### **Example**
...
Grammar-based generation for plants, trees, branching structures
  #### **When**
Creating trees, plants, rivers, coral, lightning, branching patterns
  #### **Example**
...
Generate plausible names, words, text based on statistical patterns
  #### **When**
Fantasy names, procedural dialogue, generated descriptions
  #### **Example**
...
Use simple rules to generate organic cave structures
  #### **When**
Cave systems, organic shapes, erosion simulation
  #### **Example**
...
Binary Space Partitioning for structured dungeon layouts
  #### **When**
Roguelike dungeons, room-and-corridor layouts
  #### **Example**
...
Generate content on-demand for infinite worlds
  #### **When**
Open world games, Minecraft-style generation, large terrains
  #### **Example**
    # CHUNKED INFINITE WORLD GENERATION
